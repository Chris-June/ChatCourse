...
const VagueTab: React.FC = () => (
  <div className="bg-gray-900 p-4 rounded-b-xl border-t-0 border border-red-700 relative">
...
const SpecificTab: React.FC = () => (
  <div className="bg-gray-900 p-4 rounded-b-xl border-t-0 border border-green-700 relative">
    ...
    <div>
      <div className="flex border-b border-gray-700">
        <button 
          ...
          className={`px-4 py-2 text-sm font-semibold transition-colors rounded-t-xl -mb-px ${activeTab === 'specific' ? 'border border-b-0 border-green-700 bg-gray-900 text-green-400' : 'text-gray-400 hover:bg-gray-800'}`}>
            Specific
        </button>
        <button 
          onClick={() => setActiveTab('vague')}
          className={`px-4 py-2 text-sm font-semibold transition-colors rounded-t-xl -mb-px ${activeTab === 'vague' ? 'border border-b-0 border-red-700 bg-gray-900 text-red-400' : 'text-gray-400 hover:bg-gray-800'}`}>
            Vague
        </button>
      </div>
