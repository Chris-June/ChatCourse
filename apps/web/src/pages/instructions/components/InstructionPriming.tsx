...
const InstructionPriming: React.FC = () => {
  return (
    <div className="bg-card p-4 rounded-xl border text-card-foreground">
        <h3 className="font-semibold mb-2">Example: Priming the AI</h3>
        ...
        <div className="relative bg-muted p-4 rounded-xl border" role="region" aria-label="Priming instruction template">
