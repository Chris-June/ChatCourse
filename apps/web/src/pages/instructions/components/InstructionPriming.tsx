...
const InstructionPriming: React.FC = () => {
  return (
    <div className="bg-card p-4 rounded-xl border border-border shadow-sm">
        <h3 className="font-semibold text-card-foreground mb-2">Example: Priming the AI</h3>
