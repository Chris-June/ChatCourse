...
const RagChunkingDiagram: React.FC = () => {
  return (
    <div className="bg-gray-900 p-6 rounded-lg border border-dashed border-gray-700">
      <h3 className="text-lg font-semibold text-white mb-2 text-center">Building Your AI's Library: The Art of RAG Chunking</h3>
      <p className="text-xs text-gray-400 text-center mb-6">Think of it like a master librarian organizing a vast, chaotic library into a perfect card catalog.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-center mb-6">
        ...
        <div className="text-center col-span-2">
          <div className="bg-red-900/30 border border-red-700 rounded-lg p-4 h-full">
            <Book className="w-8 h-8 text-red-400 mx-auto mb-2" />
            <h4 className="font-semibold text-red-300 mb-1">The Unwieldy Tome</h4>
            <p className="text-xs text-gray-400">A massive, single document (e.g., a 200-page PDF).</p>
        ...
        <div className="text-center col-span-2">
          <div className="bg-green-900/30 border border-green-700 rounded-lg p-4 h-full">
            <ClipboardList className="w-8 h-8 text-green-400 mx-auto mb-2" />
            <h4 className="font-semibold text-green-300 mb-1">The Card Catalog</h4>
            <p className="text-xs text-gray-400">The tome is broken down into small, context-rich index cards.</p>
            <div className="mt-2 bg-green-800/50 rounded p-2">
