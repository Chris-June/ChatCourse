...
const Highlight = ({ children }: { children: React.ReactNode }) => (
  <span className="bg-primary/10 text-primary px-1 py-0.5 rounded">{children}</span>
);

const HighlightGreen = ({ children }: { children: React.ReactNode }) => (
    <span className="bg-emerald-900/10 text-emerald-400 px-1 py-0.5 rounded">{children}</span>
  );
...
const Card = ({ title, titleColor, children }: { title: string; titleColor: string; children: React.ReactNode }) => (
  <div className="bg-card border border-border rounded-xl p-4 h-full shadow-sm">
  ...
  return (
    <div className="my-6 grid md:grid-cols-2 gap-6">
      ...
      <PromptingColumn title="Standard Prompting (Calculator Mode)">
        ...
        <Card title="Model Input" titleColor="bg-primary/10 text-primary">
        ...
        <Card title="Model Output" titleColor="bg-emerald-900/10 text-emerald-400">
          <div className="flex items-center">
            <p className="flex-grow"><span className="font-bold">A:</span> The answer is 27.</p>
            <X className="w-6 h-6 text-destructive ml-2" />
          </div>
      ...
      <PromptingColumn title="Chain-of-Thought Prompting (Teacher Mode)">
        ...
        <Card title="Model Output" titleColor="bg-emerald-900/10 text-emerald-400">
            <div className="flex items-center">
                ...
                <Check className="w-6 h-6 text-emerald-400 ml-2" />
            </div>
