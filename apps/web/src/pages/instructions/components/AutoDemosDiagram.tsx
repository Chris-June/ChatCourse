    ...
    <div className="my-6 p-4 bg-card border border-border rounded-xl text-sm shadow-sm">
        ...
        <div className="grid md:grid-cols-2 gap-x-8 gap-y-4">
            ...
            <div className="flex flex-col items-center space-y-3">
                <div className="text-xs text-muted-foreground mb-2">Step 1: Collect diverse questions</div>
                ...
                <Box className="w-full">
                    ...
                    <p className="text-center py-1">...</p>
                    <p>k. Q: Cooking potatoes... A: <span className="text-primary">Let's think step by step...</span></p>
                    <p className="text-center text-xs text-muted-foreground mt-2">Quality & Diversity Selection</p>
                </Box>
            </div>
