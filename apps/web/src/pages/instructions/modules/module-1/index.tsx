...
import OverviewModule1 from './Overview';
...
const Module1Routes: React.FC = () => {
  ...
  // If the path is exactly /instructions/module-1, redirect to the module overview
  if (location.pathname === '/instructions/module-1') {
    return <Navigate to="/instructions/module-1/overview" replace />;
  }

  return (
    <Routes>
      <Route path="/" element={<Module1Page />}>
        <Route path="overview" element={<OverviewModule1 />} />
